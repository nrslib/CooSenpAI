...
export function ProviderSettings({ form, snapshot, saving, update, errorFor, providerModels, providerApiKeys, providerApiKeysError, onChangeProvider, onSaveProviderApiKey, onDeleteProviderApiKey }: Props): ReactElement {
  return <>
    ...
    <fieldset id="settings-provider-detail"><legend>詳細</legend>
      <h3>Vision AI</h3>
      ...
      <ProviderApiKeyFields status={providerApiKeys} error={providerApiKeysError} disabled={saving} onSave={onSaveProviderApiKey} onDelete={onDeleteProviderApiKey} />
    </fieldset>
  </>;
}
