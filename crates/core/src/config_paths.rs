...
pub struct ConfigPaths {
    ...
    pub archive: PathBuf,
    pub utterance_feedback: PathBuf,
    pub utterance_feedback_archive: PathBuf,
    pub outbox: PathBuf,
    ...
    pub audio_migration: PathBuf,
    pub audio_consumed: PathBuf,
...
impl ConfigPaths {
    pub fn from_root(root: PathBuf) -> Self {
        Self {
            ...
            utterance_feedback: root.join("state/utterance-feedback.jsonl"),
            utterance_feedback_archive: root.join("state/utterance-feedback"),
            outbox: root.join("state/outbox"),
            observations: root.join("state/observations"),
            transcripts: root.join("state/transcripts"),
            speakers: root.join("state/speakers"),
            ...
            audio_migration: root.join("state/audio-migration.json"),
            audio_consumed: root.join("state/audio-consumed.json"),
